...
De afspraken over gedeelde Studio-helpers staan in
[decisions/ADR-008-studio-content-module-architecture.md](decisions/ADR-008-studio-content-module-architecture.md).
